		...
		<main >
			...
			<table>
				...
				<tr>
					...
					<td><a href="./bill_process/approve.php?id=<?php echo $bill['bill_id'] ?>" style="color: darkred;">Duyệt</a></td>
					<td><a href="./bill_process/cancel.php?id=<?php echo $bill['bill_id'] ?>"  style="color: darkred;">Hủy</a></td>
				</tr>
			<?php } ?>
			</table>
