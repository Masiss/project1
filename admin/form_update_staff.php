...
<body>
	<div>
		...
		<p style=" margin-bottom: 0;">
			Giới tính:
			<br>
			<p style="margin: 0;">Nam<input style="width:15px;" id="gender" type="radio" name="gender" value="Male"
		...
		<p>
			Số điện thoại:
			<br>
			<input id="phone" type="number" name="staff_phone" value="<?php echo $each['staff_phone'] ?>">
